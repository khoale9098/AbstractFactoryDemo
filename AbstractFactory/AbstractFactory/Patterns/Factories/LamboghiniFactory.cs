...
{
    class LamboghiniFactory : AbstractFactory
    {
        CreatingBackgroundWorker doorWorker, wheelWorker, seatWorker, frameWorker,engineWorker;

        public LamboghiniFactory(List<ProgressBar> pgrs, List<Label> lbls, Car car) : base(pgrs, lbls, car)
        {
            doorWorker =
        ...
        {
            if (doorWorker == null && wheelWorker == null && seatWorker == null && frameWorker == null && engineWorker == null)
                return false;
